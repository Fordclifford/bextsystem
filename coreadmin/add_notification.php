...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    if($last_id)
    {
    	$_SESSION['success'] = "Message added sent!";
...
<div class="row">
    ...
    <form class="form" name="login" action="" method="post"  id="church_form" onSubmit="return validatePassword()" enctype="multipart/form-data">
