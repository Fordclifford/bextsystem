...
$query = "SELECT date_added, amount from actual_income where church_id=$church ORDER BY date_added ASC";
...
<?php if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true) : ?>
    ...
    <div id="page-wrapper">
        ...
        <script>
            ...
            var bdateValues = [<?php echo join($b_date, ',') ?>];
