...
<div >
        <div >
            ...
            <form onsubmit="return DateCheck();" action="ajax/expense/expenseExcel.php" id="excel_form" name="excel_form" method="post" class="well form-horizontal ">
                <div class="modal-header">
                       <h4 class="modal-title" id="myModalLabel">Exporting Estimated Expenses to Excel </h4>
                </div>
