...
<div >
        <div >
            ...
            <form onsubmit="return DateCheck()" action="ajax/bill/billsPdf.php" id="excel_form" name="excel_form" method="post" class="well form-horizontal ">
                <div class="modal-header">
                       <h4 class="modal-title" id="myModalLabel">Exporting Bills to Pdf </h4>
                </div>
